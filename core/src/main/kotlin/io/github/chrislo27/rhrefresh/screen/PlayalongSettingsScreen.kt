...
import io.github.chrislo27.rhrefresh.playalong.*
...
class PlayalongSettingsScreen(main: RHREfreshApplication, val lastScreen: Screen?)
    : ToolboksScreen<RHREfreshApplication, PlayalongSettingsScreen>(main) {
