package io.github.chrislo27.rhrefresh.entity.model.cue

import com.badlogic.gdx.graphics.Color
import com.badlogic.gdx.math.MathUtils
import com.fasterxml.jackson.databind.node.ObjectNode
import io.github.chrislo27.rhrefresh.editor.Editor
import io.github.chrislo27.rhrefresh.entity.model.*
import io.github.chrislo27.rhrefresh.entity.model.special.PitchBenderEntity
import io.github.chrislo27.rhrefresh.screen.EditorScreen
import io.github.chrislo27.rhrefresh.sfxdb.BaseBpmRules
...
class CueEntity(remix: Remix, datamodel: Cue)
    ...
    private fun createDerivative(): Derivative {
        return Derivative(((cue.getBaseBpmRate(this.bounds.x) - 1f)+1), semitone.toFloat(), 0f)
    }
