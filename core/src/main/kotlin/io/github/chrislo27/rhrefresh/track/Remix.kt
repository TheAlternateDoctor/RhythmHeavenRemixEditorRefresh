...
import io.github.chrislo27.rhrefresh.entity.model.special.*
import io.github.chrislo27.rhrefresh.undoredo.ActionHistory
import io.github.chrislo27.rhrefresh.playalong.Playalong
import io.github.chrislo27.rhrefresh.rhre2.RemixObject
...
import io.github.chrislo27.rhrefresh.sfxdb.datamodel.impl.special.Subtitle
import io.github.chrislo27.rhrefresh.soundsystem.*
import io.github.chrislo27.rhrefresh.track.timesignature.TimeSignature
import io.github.chrislo27.rhrefresh.track.timesignature.TimeSignatures
import io.github.chrislo27.rhrefresh.track.tracker.TrackerContainer
import io.github.chrislo27.rhrefresh.track.tracker.musicvolume.MusicVolumeChange
import io.github.chrislo27.rhrefresh.track.tracker.musicvolume.MusicVolumes
import io.github.chrislo27.rhrefresh.track.tracker.tempo.TempoChange
import io.github.chrislo27.rhrefresh.track.tracker.tempo.TempoChanges
import io.github.chrislo27.rhrefresh.util.JsonHandler
import io.github.chrislo27.rhrefresh.util.Swing
import io.github.chrislo27.rhrefresh.util.settableLazy
...
open class Remix(val main: RHREfreshApplication)
    ...
    companion object {
        ...
        fun fromJson(tree: ObjectNode, remix: Remix, preloadSounds: Boolean): RemixLoadInfo {
            ...
            fun fromThisVersion(version: Version): Boolean {
                return remix.version < version && RHREfresh.VERSION >= version
            }
...
//                                println("Got command $command ${message.data1} ${message.data2}")
        ...
        fun pack(remix: Remix, stream: ZipOutputStream, isAutosave: Boolean) {
            ...
            stream.setComment("Rhythm Heaven Remix Editor Refresh savefile - ${RHREfresh.VERSION}")
    ...
    val timeStretchingAllowed: Boolean
        get() = Ffmpeg.isSupported && !main.settings.disableTimeStretching
...
//                }
            ...
            if (music.music.isPlaying()) {
                ...
                // Music distort
                val beadsMusic: BeadsMusic? = music.music
                if (beadsMusic != null) {
